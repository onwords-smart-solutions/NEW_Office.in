...
const deleteAccess = document.getElementById('delete-access')

function permissionBtn() {
    const staffAccess = document.getElementById('staff-access')
    const deleteAccess = document.getElementById('delete-access')
    staffAccess.style.display = 'block'
    deleteAccess.style.display = 'none'
    permissionNav.classList.add('active-inv')
    deleteForm.classList.remove('active-inv')
}
function deleteBtn() {
    staffAccess.style.display = 'none'
    deleteAccess.style.display = 'block'
    permissionNav.classList.remove('active-inv')
    deleteForm.classList.add('active-inv')
}